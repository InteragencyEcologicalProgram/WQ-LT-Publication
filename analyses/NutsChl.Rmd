...
saveRDS(NutsCLa, file = here("outputs/NutrientsChlorophyll.RData"))
```
...
Export all figures of model results to be combined into a larger figure for the manuscript.

```{r}
plt_nutr_chla <- tibble(
  Parameter = rep(c("Ammonium", "Nitrate", "Orthophosphate", "Chlorophyll"), 2),
  ContrastType = c(rep("Region", 4), rep("Season", 4)),
  Plt = list(
    AmRegions$plt,
    NNRegion$plt,
    OPRegion$plt,
...
saveRDS(plt_nutr_chla, file = here("outputs/Nutr_Chl_plots.RData"))
```

...
#now the good graph of everything
pub_figure_plotter(ChlaA, Chlorophyll, "Chlorophyll-a ug/L", Region, Chl1, log_trans = T)

pub_figure_plotter(ChlaA, Chlorophyll, "Chlorophyll-a ug/L", Season, Chl1, log_trans = T)
```

---
title: "Temperature, Salinity, and Seecchi analyses"
...
Option 2: More accurate representation of the differences, but more confusing plot
```{r, fig.width=12}
# Region
pwpp(m_t_contrasts_r$emmeans, by="Region")+
  theme(axis.text.x=element_text(angle=45, hjust=1))

# Season
pwpp(m_t_contrasts_s$emmeans, by="Season")+
  theme(axis.text.x=element_text(angle=45, hjust=1))
```
...
```{r, fig.width=12}
# Region
pwpp(m_sa_contrasts_r$emmeans, by="Region")+
  theme(axis.text.x=element_text(angle=45, hjust=1))

# Season
pwpp(m_sa_contrasts_s$emmeans, by="Season")+
  theme(axis.text.x=element_text(angle=45, hjust=1))
```
...
```{r, fig.width=12}
# Region
pwpp(m_se_contrasts_r$emmeans, by="Region")+
  theme(axis.text.x=element_text(angle=45, hjust=1))

# Season
pwpp(m_se_contrasts_s$emmeans, by="Season")+
  theme(axis.text.x=element_text(angle=45, hjust=1))
```

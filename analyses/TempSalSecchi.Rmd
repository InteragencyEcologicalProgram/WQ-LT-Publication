...
```{r}
m_t_contrasts_r <- pub_figure_plotter(wq_data, Temperature, "Temperature (°C)", Region, m_t)

m_t_contrasts_s <- pub_figure_plotter(wq_data, Temperature, "Temperature (°C)", Season, m_t)
```
...
```{r}
m_sa_contrasts_r <- pub_figure_plotter(wq_data, Salinity, "Salinity", Region, m_sa, log_trans = TRUE)

m_sa_contrasts_s <- pub_figure_plotter(wq_data, Salinity, "Salinity", Season, m_sa, log_trans = TRUE)
```
...
```{r}
m_se_contrasts_r <- pub_figure_plotter(wq_data, Secchi, "Secchi depth (cm)", Region, m_se, log_trans = TRUE)

m_se_contrasts_s <- pub_figure_plotter(wq_data, Secchi, "Secchi depth (cm)", Season, m_se, log_trans = TRUE)
```
...
```{r}
m_se2_contrasts_r <- pub_figure_plotter(wq_data, Secchi, "Secchi depth (cm)", Region, m_se2, log_trans = TRUE)

m_se2_contrasts_s <- pub_figure_plotter(wq_data, Secchi, "Secchi depth (cm)", Season, m_se2, log_trans = TRUE)
```

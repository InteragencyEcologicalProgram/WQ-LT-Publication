...
pub_figure_plotter(Ammonia, DissAmmonia, "Ammonia mg/L", Region, Am2, log_trans = T)

pub_figure_plotter(Ammonia, DissAmmonia, "Ammonia mg/L", Season, Am2, log_trans = T)
...
#now the good graph of everything
pub_figure_plotter(Nitrate, DissNitrateNitrite, "Nitrate + Nitrite mg/L", Region, Nat2, log_trans = T)

pub_figure_plotter(Nitrate, DissNitrateNitrite, "Nitrate + Nitrite mg/L", Season, Nat2, log_trans = T)
...
#now the good graph of everything
pub_figure_plotter(Phos, DissOrthophos, "Orthophosphate mg/L", Region, Phos2, log_trans = T)

pub_figure_plotter(Phos, DissOrthophos, "Orthophosphate mg/L", Season, Phos2, log_trans = T)
...
Chl1 = lm(LogChl ~ Drought*Region + Drought*Season + Region*Season + Region*Regime, 
          data = ChlaA)
summary(Chl1)
plot(Chl1)
library(car)
...
## ANOVA Results and partial R2
chl_anova <- Anova(Chl1, type= 3, 
                   contrasts=list(topic=contr.sum, sys=contr.sum))
chl_anova
partial.r2(chl_anova, "Drought")
partial.r2(chl_anova, "Region")
...
## Chlorophyll-Region
pub_figure_plotter(ChlaA, Chlorophyll, "Chlorophyll-a µg/L", Region, Chl1, log_trans = T,
                   plt_title= "Chlorophyll: region")
ggsave(last_plot(), filename= "chl_region.png", width= 6.5, height= 4, dpi= 300,
                               path= here::here("figures"))

## Chlorophyll-Season
pub_figure_plotter(ChlaA, Chlorophyll, "Chlorophyll-a µg/L", Season, Chl1, log_trans = T,
                   plt_title= "Chlorophyll: season")
ggsave(last_plot(), filename= "chl_season.png", width= 6.5, height= 4, dpi= 300,
                               path= here::here("figures"))

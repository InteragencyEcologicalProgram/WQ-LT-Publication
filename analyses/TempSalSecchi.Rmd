...
```{r}
plt_wq <- tibble(
  Parameter = rep(c("Temperature", "Salinity", "Secchi"), 2),
  ContrastType = c(rep("Region", 3), rep("Season", 3)),
  Plt = list(
    m_t_contrasts_r$plt,
    m_sa_contrasts_r$plt,
    m_se2_contrasts_r$plt,
    m_t_contrasts_s$plt,
    m_sa_contrasts_s$plt,
    m_se2_contrasts_s$plt
  )
)

saveRDS(plt_wq, file = here("outputs/TempSalSecchi_plots.RData"))
```

...
# Define URL for the WQ data from the discretewq EDI data package
url_dwq <- "https://pasta.lternet.edu/package/data/eml/edi/731/7/6c5f35b1d316e39c8de0bfadfb3c9692"

# Import WQ data from the discretewq EDI data package from the local copy using its URL
df_dwq <- read_csv(
  file = url_dwq,
